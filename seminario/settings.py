"""
Django settings for seminario project.
...
SECRET_KEY = 'django-insecure-baf)#xh9ku5(^%upxx5465mi(0bmwt#6ke@!wg-t)gn_(9@=!='
...
WSGI_APPLICATION = 'seminario.wsgi.application'
